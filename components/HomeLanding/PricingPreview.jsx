      ...
      <div className="p-8 bg-[#181818] rounded-2xl shadow-2xl border border-[#525252]/50">
        ...
        <ul className="space-y-3 text-left max-w-sm mx-auto mb-8">
          <li className="flex items-center gap-3">
            <FaCheck className="text-[#9B51E0]" /> Start Free – perfect for
            small teams
          </li>
          <li className="flex items-center gap-3">
            <FaCheck className="text-[#9B51E0]" /> Pay based on conversations,
            not agent seats
          </li>
          <li className="flex items-center gap-3">
            <FaCheck className="text-[#9B51E0]" /> No surprise add-ons for
            “basic” features
          </li>
        </ul>
